            ...
            {isLocal && dnsSetup === false && displayedAgents.length > 0 && (
                <div className='border-border bg-foreground/5 relative z-10 flex items-center justify-between border-b px-6 py-2.5'>
                    ...
                    <button
                        onClick={onDnsSetup}
                        disabled={dnsLoading}
                        className='flex items-center gap-1.5 rounded-md bg-[#0072C6] px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-[#e53935] disabled:opacity-50'
                    >
                        {dnsLoading && (
