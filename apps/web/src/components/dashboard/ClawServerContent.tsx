...
import type { ClawServerContentProps } from '@/ts/Interfaces'
...
import { useReinstallClaw, useToast } from '@/hooks'
...
const ClawServerContent: FC<ClawServerContentProps> = ({ claw, plans }): ReactNode => {
    ...
    }, [claw.id, reinstallMutation, showToast])
...
export default ClawServerContent