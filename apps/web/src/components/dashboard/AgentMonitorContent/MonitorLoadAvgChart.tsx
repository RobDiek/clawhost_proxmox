...
const MonitorLoadAvgChart: FC<MonitorLoadAvgChartProps> = ({ load1, load5, load15 }): ReactNode => (
    <MetricCard title={t('clawDetail.metricsLoadAvg')} icon={<GaugeIcon className='h-4 w-4 text-amber-500' />}>
