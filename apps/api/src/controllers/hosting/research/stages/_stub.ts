...
export function notImplementedYet(c: Context, stageId: StageId): Response {
    const titleMap: Record<StageId, string> = {
        ...
        paid_setup_fork:            'הגדרת פרסום — נקודת התחלה',
        paid_data_inventory:        'מלאי נתונים — פרסום ממומן',
        client_account_baseline:    'מה אנחנו רואים בחשבון שלכם',
        paid_questionnaire:         'שאלון פרסום — מתחילים מאפס',
        paid_csv_ingest:            'יבוא דוחות CSV — פרסום ממומן',
        client_account_baseline_csv:'בייסליין חשבון — מקור CSV',
