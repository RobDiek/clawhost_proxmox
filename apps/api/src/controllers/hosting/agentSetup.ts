...
- יעדים מספריים לכל חודש (טבלה)

## 3. עמודי תוכן (Content Pillars)
- 4-5 עמודי תוכן עם דוגמאות לנושאים
- תדירות מומלצת לכל עמוד

## 4. מסע לקוח (Marketing Funnel)
- Awareness: איך מגלים אותנו? אילו ערוצים? איזה תוכן?
- Consideration: מה משכנע? השוואות? case studies? demo?
- Conversion: מה הCTA? landing page? onboarding flow?
- Retention: מה קורה אחרי signup? onboarding emails? follow-up?
- לכל שלב: ערוץ + סוג תוכן + KPI
...
## 6. A/B Testing Plan
- 3 ניסויים מומלצים לחודש הראשון
- לכל ניסוי: מה בודקים, מדד הצלחה, משך הניסוי
- דוגמאות: כותרות, CTAs, landing pages, שעות פרסום

## 7. תוכנית תגובה תחרותית
- מה עושים אם מתחרה מפרסם בעברית?
- מה עושים אם מתחרה מוריד מחיר?
- מה עושים אם מתחרה חדש נכנס לשוק?
- trigger → response → timeline

## 8. הנחיות לסוכנים
לכל אחד מ-9 הסוכנים — 2-3 משפטים:
- מטה: מה מתאם ובאיזו תדירות
- סייר: מה חוקר, אילו אתרים סורק, תדירות
- מאתר: אילו מילות מפתח עוקב, כלים
- מאזין: אילו שיחות מנטר, ברדיט/טוויטר/לינקדאין
- מנתח: מה מנתח, מודל ניקוד הזדמנויות
- עט: איזה סוג תוכן, אורך, סגנון, כללי ברזל
- יוצר: איזה ויזואלים, סגנון, פורמטים
- שליח: לאן מפיץ, מתי, כלל אישור
- מגדלור: מה בודק, באילו כלי AI, תדירות

## 9. תקציב חודשי
- חלוקה: אורגני vs ממומן (טבלה)
