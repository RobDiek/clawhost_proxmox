...
const REGISTRY: Record<IntegrationId, Omit<Requirement, 'severity'>> = {
    ...
    website_url: {
        id: 'website_url',
        label_he: 'כתובת האתר',
        valueProp_he: 'בלי כתובת אתר לא נוכל לסרוק את האתר לאודיט SEO פנימי, לחלץ קטגוריות מוצרים (לחנויות אונליין), או לבנות פרופיל של נוף תחרותי.',
        deepLink: 'agents#profile',
    },
    business_profile: {
        id: 'business_profile',
        label_he: 'פרופיל עסקי מלא',
        valueProp_he: 'נדרש: שם העסק, תיאור באורך 30+ תווים, סוג העסק, מטרות שיווק וקהל יעד. כל אלה מזינים את מנוע ההנחיות — תיאור קצר מוביל לאסטרטגיה גנרית.',
        deepLink: 'agents#questionnaire',
    },
    gsc: {
        id: 'gsc',
        label_he: 'Google Search Console',
        valueProp_he: 'מספק את שאילתות החיפוש האמיתיות שמביאות לכם תנועה, מיקום ושיעור הקלקה. בלעדיו מחקר מילות המפתח מבוסס על הערכות בלבד, במקום על הנתונים האמיתיים שלכם מגוגל.',
        deepLink: 'integrations#gsc',
    },
    dataforseo: {
        id: 'dataforseo',
        label_he: 'נתוני DataForSEO',
        valueProp_he: 'מקור הנתונים המרכזי לנפחי חיפוש, רמת קושי, תוצאות חיפוש, נראות במנועי בינה מלאכותית וקישורים נכנסים. בלעדיו רוב המחקר מבוסס על השערות. שני מצבים נתמכים: (1) קרדיטים מנוהלים דרך הפלטפורמה בתשלום לפי שימוש, או (2) חשבון אישי (מצב מתקדם).',
        deepLink: 'integrations#dataforseo',
    },
    firecrawl: {
        id: 'firecrawl',
        label_he: 'Firecrawl',
        valueProp_he: 'דרוש לאודיט ה-SEO הפנימי ולסריקה עמוקה של עמודי ההמרה של המתחרים. בלעדיו האודיט ירוץ במצב מוגבל.',
        deepLink: 'integrations#firecrawl',
    },
    brave: {
        id: 'brave',
        label_he: 'Brave Search API',
        valueProp_he: 'תוצאות חיפוש חיות — משלימות את נתוני המחקר בזמן אמת. נדרש לזיהוי מתחרים, למחקר הרשתות החברתיות ולאימות תוצאות חיפוש בעברית ובאנגלית בזמן ריצת המחקר.',
        deepLink: 'integrations#brave',
    },
    wordpress: {
        id: 'wordpress',
        label_he: 'WordPress (פרסום בלוג)',
        valueProp_he: 'יעד פרסום אוטומטי למאמרים מתוכנית התוכן. בלעדיו תוכן הבלוג יישאר בקבצים בלבד — בלי פרסום למערכת ניהול התוכן שלכם.',
        deepLink: 'integrations#wordpress',
    },
    google_workspace: {
        id: 'google_workspace',
        label_he: 'Google Workspace (GA4 / GTM)',
        valueProp_he: 'GA4 מספק נתוני המרה לחישוב החזר אמיתי על ההוצאה הפרסומית. GTM מאפשר המלצות מדידה ומיפוי אירועים.',
        deepLink: 'integrations#google',
    },
    google_ads: {
        id: 'google_ads',
        label_he: 'Google Ads',
        valueProp_he: 'נדרש לאודיט הפרסום הממומן ולתוכנית המדיה, עם נתוני עלות-להקלקה ושיעורי המרה מכוילים לעסק שלכם — במקום הערכות גנריות.',
        deepLink: 'integrations#google',
    },
    meta_ads: {
        id: 'meta_ads',
        label_he: 'Meta Ads (פייסבוק / אינסטגרם)',
        valueProp_he: 'נדרש לאודיט הפרסום הממומן, לתוכנית המדיה ולאסטרטגיית הרימרקטינג. את הפרסום באינסטגרם אפשר להפעיל רק עם חיבור.',
        deepLink: 'integrations#meta',
    },
    github: {
        id: 'github',
        label_he: 'GitHub',
        valueProp_he: 'אופציונלי — לפרסום אוטומטי של מאמרי בלוג שנוצרו על-ידי הסוכן למאגר הקוד של האתר (Cloudflare Pages / Vercel / Netlify).',
        deepLink: 'integrations#github',
    },
    gbp: {
        id: 'gbp',
        label_he: 'Google Business Profile',
        valueProp_he: 'קריטי לעסק מקומי — דירוג במפות, מעקב ביקורות ותזמון פוסטים. בלעדיו ה-SEO המקומי לא רץ.',
