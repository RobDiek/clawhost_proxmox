...
export const INTEGRATIONS: IntegrationInfo[] = [
    ...
    },
    {
        ...
        descHe: 'חיבור אחד = שליטה מלאה: דפי Facebook, חשבונות Instagram Business, חשבונות פרסום, Pixel, Conversion API (CAPI), Lead Forms, Catalogs, Custom Audiences. חיבור נפרד ל-Facebook Pages / Instagram אינו נדרש — Meta Business מכסה את כולם.',
        icon: '📘',
        ...
        recommendedFor: ['lead_generation', 'ecommerce', 'brand_awareness', 'social_organic'],
    },
    {
        id: 'gtm',
    ...
    // ── Social publishing ─────────────────────────────────────────────────
    {
        ...
        descHe: 'פרסום אורגני, Stories, Reels, אנליטיקס. **כלול ב-Meta Business Manager** — אם כבר חיברתם את Meta Business, אינסטגרם כבר נגיש.',
        icon: '📷',
    ...
    },
    {
        ...
        descHe: 'דף פייסבוק — פרסום, תגובות, אנליטיקס. **כלול ב-Meta Business Manager** — אם כבר חיברתם את Meta Business, דפי פייסבוק כבר נגישים. חיבור נפרד מיועד רק למצבים בהם אין גישה לעסק ב-Meta Business (e.g. רק admin של הדף).',
        icon: '👍',
        capabilities: ['social_publishing'],
        auth: 'oauth_meta',
        cost: 'free',
