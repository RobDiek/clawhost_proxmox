...
export const INTEGRATIONS: IntegrationInfo[] = [
    ...
    },
    {
        ...
        nameHe: 'DataForSEO',
        nameEn: 'DataForSEO',
        descHe: 'נפחי חיפוש אמיתיים, CPC, רמת תחרות, SERP scraping, backlinks. **המערכת מספקת אשראי התחלתי של $10 דרך Flowmatic proxy** — מספיק לאונבורדינג מלא. אחרי שהאשראי מתכלה, חברו חשבון אישי כדי להמשיך.',
        icon: '📊',
    ...
    },
    {
        ...
        descHe: 'חיבור אחד = שליטה מלאה: דפי Facebook, חשבונות Instagram Business, חשבונות פרסום, Pixel, Conversion API (CAPI), Lead Forms, Catalogs, Custom Audiences. **אופציונלי**: ניתן לפרסם ידנית בלי חיבור — Mazhir יציע תוכן + creatives להדבקה ידנית, אבל יוותר על אוטומציית פרסום, attribution ו-fatigue alerts.',
        icon: '📘',
    ...
    // ── Social publishing ─────────────────────────────────────────────────
    {
        ...
        descHe: 'פרסום אורגני, Stories, Reels, אנליטיקס. **כלול ב-Meta Business Manager** — אם כבר חיברתם את Meta Business, אינסטגרם כבר נגיש. **אופציונלי**: ניתן לפרסם ידנית — Mazhir יציע תוכן + media-pack להדבקה ב-IG app.',
        icon: '📷',
