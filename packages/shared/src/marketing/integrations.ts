...
export const INTEGRATIONS: IntegrationInfo[] = [
    // ── Search / SEO intelligence ─────────────────────────────────────────
    {
        ...
        descHe: 'נתוני החיפוש האורגני שלכם — שאילתות, CTR, מיקומים. Mazhir משתמש בזה כדי לזהות קניבליזציה בין ממומן לאורגני ומילים שכבר ממירות אורגנית',
        icon: '🔎',
    ...
    },
    {
        ...
        nameHe: 'DataForSEO',
        nameEn: 'DataForSEO',
        descHe: 'נפחי חיפוש אמיתיים, CPC, רמת תחרות, איסוף תוצאות חיפוש, קישורים נכנסים. **המערכת מספקת אשראי התחלתי של $10 דרך פרוקסי של Flowmatic** — מספיק לאונבורדינג מלא. אחרי שהאשראי מתכלה, חברו חשבון אישי כדי להמשיך.',
        icon: '📊',
        capabilities: ['keyword_research', 'serp_analysis'],
        auth: 'apikey',
        cost: 'usage',
        costNote: '$10 startup credit כלול; ~$5/חודש (תשלום לפי שימוש) אחרי כן',
        available: true,
        recommendedFor: ['seo', 'paid_search', 'content', 'paid_social', 'ecommerce', 'lead_generation'],
    },
    {
        id: 'firecrawl',
        nameHe: 'Firecrawl',
    ...
    },
    {
        ...
        nameHe: 'Brave Search',
        nameEn: 'Brave Search',
        descHe: 'אינדקס חיפוש עצמאי — מקור משלים לזיהוי הזדמנויות (פחות רלוונטי ל-Google Ads)',
        icon: '🦁',
    ...
    // ── Paid ads infrastructure ───────────────────────────────────────────
    {
        ...
        nameHe: 'Google Ads',
        nameEn: 'Google Ads',
        descHe: 'חיבור OAuth + מזהה לקוח — ניהול קמפיינים, היסטוריה, דוח מונחי חיפוש, Auction Insights',
        icon: '💰',
    ...
    {
        id: 'meta_ads',
        nameHe: 'Meta Business Manager',
        nameEn: 'Meta Business Manager',
        descHe: 'חיבור אחד = שליטה מלאה: דפי Facebook, חשבונות Instagram Business, חשבונות פרסום, Pixel, ממשק המרות שרת (CAPI), טפסי לידים, קטלוגים, קהלים מותאמים. **אופציונלי**: ניתן לפרסם ידנית בלי חיבור — Mazhir יציע תוכן + קריאייטיבים להדבקה ידנית, אבל יוותר על אוטומציית פרסום, ייחוס המרות והתראות שחיקת קריאייטיב.',
        icon: '📘',
        capabilities: ['paid_ads_social', 'social_publishing'],
        auth: 'oauth_meta',
        cost: 'free',
        available: true,
        recommendedFor: ['paid_social', 'lead_generation', 'ecommerce', 'brand_awareness', 'social_organic'],
    },
    {
        id: 'gtm',
        nameHe: 'Google Tag Manager',
        nameEn: 'Google Tag Manager',
        descHe: 'ניהול תגיות המרה, Conversion Linker, GCLID — Mazhir מגדיר אוטומטית',
        icon: '🏷️',
    ...
    },
    {
        ...
        descHe: 'מקור האמת להמרות ולנתוני התנהגות — חובה להצעות מחיר חכמות',
        icon: '📈',
    ...
    },
    {
        ...
        descHe: 'מודעות פעילות של מתחרים ב-Google Ads כרגע — Mazhir משתמש בהן כבסיס ייחוס ל-RSA. ספריה ציבורית של Google, לא צריך לחבר',
        icon: '',
    ...
    },
    {
        ...
        descHe: 'מודעות פעילות של מתחרים בפייסבוק/אינסטגרם — דנ״א קריאייטיבי, רעיונות קופי. ספריה ציבורית של Meta, לא צריך לחבר',
        icon: '',
        capabilities: ['ads_competitive'],
        auth: 'builtin',
        cost: 'free',
    ...
    // ── CMS ───────────────────────────────────────────────────────────────
    {
        ...
        nameHe: 'WordPress',
        nameEn: 'WordPress',
        descHe: 'גישה ל-REST API של WordPress — פרסום מאמרים, אודיט לדפי נחיתה, schema. **חלופה ל-GitHub** עבור אתרי WordPress — חברו אחד מהשניים, לפי הפלטפורמה של האתר שלכם.',
        icon: '🌐',
        capabilities: ['cms'],
        auth: 'apikey',
        cost: 'free',
    ...
    },
    {
        ...
        nameHe: 'GitHub',
        nameEn: 'GitHub',
        descHe: 'פרסום תוכן לאתר מבוסס-Git (Next.js / Cloudflare Pages / Vercel / Netlify) — הסוכן דוחף מאמר/דף למאגר הקוד והבנייה רצה אוטומטית. **חלופה ל-WordPress** עבור אתרים סטטיים — חברו אחד מהשניים, לפי הפלטפורמה של האתר שלכם.',
        icon: '🐙',
        capabilities: ['cms'],
        auth: 'github_repo',
        cost: 'free',
    ...
    },
    {
        ...
        nameHe: 'Shopify',
        nameEn: 'Shopify',
        descHe: 'קטלוג מוצרים, פידים לרימרקטינג דינמי, אירועי המרה',
        icon: '🛍️',
    ...
    // ── Social publishing ─────────────────────────────────────────────────
    {
        ...
        descHe: 'פרסום אורגני, Stories, Reels, אנליטיקס. **כלול ב-Meta Business Manager** — אם כבר חיברתם את Meta Business, אינסטגרם כבר נגיש. **אופציונלי**: ניתן לפרסם ידנית — Mazhir יציע תוכן + חבילת מדיה להדבקה באפליקציית אינסטגרם.',
        icon: '📷',
    ...
    },
    {
        ...
        descHe: 'דף פייסבוק — פרסום, תגובות, אנליטיקס. **כלול ב-Meta Business Manager** — אם כבר חיברתם את Meta Business, דפי פייסבוק כבר נגישים. **אופציונלי**: ניתן לפרסם ידנית בדף.',
        icon: '👍',
        capabilities: ['social_publishing'],
        auth: 'oauth_meta',
        cost: 'free',
        available: true,
        recommendedFor: ['social_organic', 'paid_social'],
    },
    {
        id: 'linkedin',
        nameHe: 'LinkedIn',
    ...
    },
    {
        ...
        nameHe: 'HubSpot',
        nameEn: 'HubSpot',
        descHe: 'CRM + אוטומציה — לידים, עסקאות, ניקוד לידים, המרות לא-מקוונות',
        icon: '🎯',
    ...
    // ── Creative ─────────────────────────────────────────────────────────
    {
        ...
        nameHe: 'Canva',
        nameEn: 'Canva',
        descHe: 'גישה לערכת מותג, יצירת ויזואלים, ייצוא',
        icon: '🎨',
