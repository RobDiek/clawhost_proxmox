...
export const INTENTS: IntentInfo[] = [
    ...
    { id: 'content',         nameHe: 'שיווק תוכן',                nameEn: 'Content Marketing', descHe: 'מאמרים, מדריכים, מגנטי לידים',                       icon: '',  category: 'organic' },
    ...
    { id: 'ecommerce',       nameHe: 'מסחר אונליין',              nameEn: 'E-Commerce',        descHe: 'קטלוג מוצרים, רימרקטינג דינמי, עגלות נטושות',         icon: '',  category: 'commerce' },
    { id: 'lead_generation', nameHe: 'איסוף לידים',               nameEn: 'Lead Generation',   descHe: 'טפסים → CRM, מסעות לקוח, ניקוד לידים',               icon: '',  category: 'acquisition' },
