...
export const PIPELINES: PipelineDef[] = [
    // ── Research family ──────────────────────────────────────────────────
    {
        ...
        descHe: 'מתחרים, מילות מפתח עם CPC, מטריצת כוונות, ערוצי גיוס',
    ...
    },
    {
        ...
        nameHe: 'מחקר SEO',
        nameEn: 'SEO Research',
        descHe: 'מילות מפתח אורגניות, פערי תוכן, בסיס SEO טכני',
        intents: ['seo'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'נושאים, פורמטים, מגנטי לידים, תדירות פרסום',
        intents: ['content'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'פלטפורמות, פורמטים, תדירות, האשטגים, משפיענים',
    ...
    },
    {
        ...
        descHe: 'רשימות תפוצה, שלבי מחזור חיים, בסיס מסירוּת',
    ...
    },
    {
        ...
        descHe: 'כלכלת יחידה, AOV, תדירות רכישה, מדדי השוואה לעגלות נטושות',
        intents: ['ecommerce'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'סינתזה של כל המחקרים → תוכנית עבודה למספר סוכנים, תרחישים',
    ...
    },
    {
        ...
        descHe: 'קמפיינים, קבוצות מודעות, RSA, מילות מפתח עם נפחים/CPC, מילות שלילה',
        intents: ['paid_search'],
        requires: ['google_ads'],
    ...
    },
    {
        ...
        descHe: 'Conversion Linker, לכידת GCLID, טריגרים לאירועים מותאמים, תגיות המרה',
    ...
    },
    {
        ...
        descHe: 'יצירת פעולות המרה ב-Google Ads דרך API',
        intents: ['paid_search'],
    ...
    },
    {
        ...
        descHe: 'יצירת קמפיינים, קבוצות מודעות, RSA, מילות מפתח, מילות שלילה במצב מושהה',
        intents: ['paid_search'],
    ...
    // ── Meta paid ────────────────────────────────────────────────────────
    {
        ...
        nameEn: 'Meta Audit',
        descHe: 'אודיט Pixel, CAPI, חשבון, קהלים',
        intents: ['paid_social'],
        requires: ['meta_ads'],
    ...
    },
    {
        ...
        descHe: 'קמפיינים, קהלים, בריפים קריאייטיביים',
        intents: ['paid_social'],
        requires: ['meta_ads'],
    ...
    },
    {
        ...
        descHe: 'יצירת קמפיינים במצב מושהה',
        intents: ['paid_social'],
        requires: ['meta_ads'],
        improvesWith: [],
    ...
    // ── SEO ops ──────────────────────────────────────────────────────────
    {
        ...
        nameHe: 'אודיט SEO',
        nameEn: 'SEO Audit',
        descHe: 'אופטימיזציית עמוד, בסיס טכני, אינדוקס, Core Web Vitals',
        intents: ['seo'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'מיקוד לכל עמוד, בריפים לתוכן, קישור פנימי',
        intents: ['seo'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'סריקה, מפת אתר, robots, schema, hreflang',
        intents: ['seo'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'מה מתחרים מכסים שאתם לא, מתועדף לפי פוטנציאל תנועה',
        intents: ['seo', 'content'],
        requires: [],
    ...
    },
    {
        ...
        descHe: 'פרסום אוטומטי / חצי-אוטומטי לפי לוח — ל-WordPress או למאגר הקוד ב-GitHub',
        intents: ['content'],
    ...
    },
    {
        ...
        descHe: 'מסעות לקוח: ברוכים הבאים, עגלה נטושה, חידוש מעורבות',
    ...
    // ── E-commerce ───────────────────────────────────────────────────────
    {
        ...
        descHe: 'פיד ל-Google Merchant + קטלוג Meta',
        intents: ['ecommerce'],
    ...
    // ── Lead generation ──────────────────────────────────────────────────
    {
        ...
        nameHe: 'נתב לידים',
        nameEn: 'Lead Router',
        descHe: 'טפסים → CRM, ניקוד לידים, התראות',
