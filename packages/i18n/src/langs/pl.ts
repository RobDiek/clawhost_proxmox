...
const pl: Translations = {
    ...
    api: {
        ...
        clawDeletionAlreadyPassed: 'Data usunięcia już minęła!',
        clawLimitReached:
            'Osiągnięto limit {{max}} claws. Skontaktuj się ze wsparciem, aby zwiększyć ten limit !',
        sshKeyLimitReached:
            'Osiągnięto limit {{max}} kluczy SSH. Skontaktuj się ze wsparciem, aby zwiększyć ten limit !',
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Pobierz tego agenta i wszystkie jego dane jako plik .zip.',
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'Włącz podgląd, aby osadzić agenta bezpośrednio w panelu.',
        ...
        volumesEmptyDescription: 'Ta instancja nie ma trwałych wolumenów magazynowych.',
        volumesReadOnly: 'Magazyn można dodać tylko podczas tworzenia instancji. Aby dodać magazyn, wdróż nową instancję z żądanym rozmiarem wolumenu lub skontaktuj się z',
        ...
        metricsErrorDescription: 'Nie można połączyć się z serwerem w celu pobrania metryk. Sprawdź, czy instancja jest uruchomiona.',
