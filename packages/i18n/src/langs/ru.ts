...
const ru: Translations = {
    ...
    api: {
        ...
        enablePreviewSuccess: 'Режим предварительного просмотра успешно включён.',
        failedToEnablePreview: 'Не удалось включить режим предварительного просмотра!',
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Скачать этого агента и все его данные как .zip-файл.',
        exportStarted:
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'Включите предпросмотр, чтобы встроить агента прямо в панель управления.',
        ...
        volumesEmptyDescription: 'У этого экземпляра нет постоянных томов хранения.',
        volumesReadOnly: 'Хранилище можно добавить только при создании экземпляра. Чтобы добавить хранилище, разверните новый экземпляр с нужным размером тома или свяжитесь с',
        ...
        metricsErrorDescription: 'Не удалось подключиться к серверу для получения метрик. Пожалуйста, проверьте, что экземпляр запущен.',
        metricsAutoRefresh: 'Автоматическое обновление каждые {{seconds}} секунд',
        tabBilling: 'Billing',
