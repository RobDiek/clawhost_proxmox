...
const ru: Translations = {
    ...
    changelog: {
        ...
        release13Date: '19 марта 2026',
        release13Title: 'Новые языки и бета ClawHost Go',
        release13Description:
            '10 новых языков и бета-версия ClawHost Go для локального развёртывания OpenClaw на macOS и Windows в один клик.',
        release13Feature1:
