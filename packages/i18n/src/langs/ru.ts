...
const ru: Translations = {
    ...
    go: {
        ...
        whyClawNodeGo: 'Все возможности в одном месте',
        featuresDescription:
        ...
        faqDescription: 'Всё, что нужно знать о ClawNode Go.',
        faq1Question: 'Что такое ClawNode Go?',
        faq1Answer:
            'ClawNode Go — это лёгкое настольное приложение, позволяющее запускать OpenClaw локально на вашем компьютере. Облачные серверы не нужны — установите, запустите и начните использовать OpenClaw за секунды.',
        faq2Question: 'Чем Go отличается от ClawNode Cloud?',
        faq2Answer:
            'ClawNode Cloud разворачивает OpenClaw на выделенных удалённых серверах с круглосуточной доступностью и глобальным доступом. ClawNode Go запускает всё локально на вашем устройстве — идеально для конфиденциальности, автономной работы и простых сценариев.',
        faq3Question: 'Нужно ли интернет-соединение?',
        faq3Answer:
            'ClawNode Go работает офлайн для локального использования. Интернет-соединение необходимо только для первоначальной настройки, обновлений и функций, требующих внешних API-вызовов.',
        faq4Question: 'Лицензия оплачивается разово?',
        faq4Answer:
            'Да. Вы платите один раз и получаете пожизненный доступ к ClawNode Go, включая все будущие обновления. Без подписок, без периодических платежей.',
        faq5Question: 'Какие операционные системы поддерживаются?',
        faq5Answer:
            'ClawNode Go поддерживает Windows и macOS. Обе платформы получают одинаковые функции и обновления одновременно.',
        faq6Question: 'Можно ли перейти с Go на Cloud позже?',
        faq6Answer:
            'Конечно. Вы можете экспортировать конфигурацию OpenClaw из Go и развернуть её в ClawNode Cloud в любое время. Обе платформы полностью совместимы.',
        statsPrice: '${{price}}',
        ...
        deviceNotSupported: 'Ваше устройство пока не поддерживается ClawNode Go.',
    ...
    footer: {
        ...
        productDescription:
            'Разворачивайте агентов OpenClaw и Hermes в облаке или локально в один клик — создавайте, подключайте и масштабируйте ваших ИИ-агентов быстрее с ClawNode.',
        ariaGithub: 'GitHub',
        ariaX: 'X',
    ...
    emails: {
        otpSubject: 'Ваш код для входа в ClawNode',
        otpPreview: 'Ваш код для входа в ClawNode: {{code}}',
        otpHeading: 'Ваш код для входа:',
        otpExpiry:
            'Срок действия кода истекает через 10 минут. Если это были не вы, проигнорируйте это письмо.',
        featureFooter:
            'Вы получили это письмо, потому что у вас есть аккаунт ClawNode.',
        features: {
            terminal: {
                ...
                description:
                    'Получите доступ к серверу прямо из браузера с помощью встроенного терминала. Не нужен SSH-клиент — просто откройте ClawNode и начните вводить команды.',
            ...
            logs: {
                ...
                description:
                    'Отслеживайте логи сервера в реальном времени из панели ClawNode. Диагностируйте проблемы, отслеживайте развёртывания и отлаживайте приложения, не покидая браузер.',
            ...
            fileExplorer: {
                ...
                description:
                    'Просматривайте, читайте и редактируйте файлы на сервере прямо из панели ClawNode. Подсветка синтаксиса, поиск и мгновенное сохранение — без SSH.',
            ...
            sshKeys: {
                subject: 'Знаете ли вы? Управляйте SSH-ключами из ClawNode',
                preview: 'Генерируйте и управляйте парами SSH-ключей в панели',
                tag: 'SSH-ключи',
                heading: 'SSH-ключи — просто',
                description:
                    'Генерируйте пары SSH-ключей, копируйте открытые ключи и скачивайте закрытые — всё из панели ClawNode. Назначайте ключи клоу для безопасного доступа.',
            ...
            multiLanguage: {
                subject: 'Знаете ли вы? ClawNode говорит на вашем языке',
                preview: 'Используйте ClawNode на 14 языках',
                tag: 'Мультиязычность',
                heading: 'ClawNode на вашем языке',
                description:
                    'Переключите всю панель ClawNode на любой из 14 языков. Всё — от кнопок до сообщений об ошибках — полностью переведено.',
                cta: 'Сменить язык'
            },
            subdomain: {
            ...
            darkMode: {
                subject: 'Знаете ли вы? В ClawNode есть тёмная тема',
                preview: 'Переключайтесь между светлой и тёмной темами',
                tag: 'Тёмный режим',
                heading: 'Комфорт для глаз',
                description:
                    'Переключайтесь между светлой и тёмной темами в панели ClawNode. Ваши предпочтения сохраняются и применяются автоматически при каждом посещении.',
    ...
    auth: {
        ...
        signInDescription:
            'Войдите в аккаунт ClawNode для управления экземплярами OpenClaw.',
    ...
    account: {
        title: 'Аккаунт',
        description:
            'Управляйте настройками аккаунта ClawNode и информацией профиля.',
    ...
    license: {
        ...
        gateDescription:
            'Вам нужна лицензия ClawNode Go для развёртывания и управления экземплярами OpenClaw локально.'
    },
    network: {
    ...
    dashboard: {
        ...
        dnsSetupBanner:
            'Настройте локальный DNS для доступа к клоу через subdomain.clawnode.',
    ...
    landing: {
        ...
        tutorialVideoThumbnail: 'Миниатюра обучающего видео ClawNode',
        ...
        faq1Question: 'Что такое ClawNode?',
        faq1Answer:
            'ClawNode — это платформа, которая делает OpenClaw и Hermes доступными для всех. Она позволяет как нетехническим пользователям, так и разработчикам запускать их без управления инфраструктурой. Мы берём на себя серверы, аптайм, безопасность и обслуживание — а вы просто используете своих агентов.',
        ...
        faqHermesAnswer:
            'Hermes — это автономный ИИ-агент с веб-просмотром, управлением календарём, мультимодельным рассуждением и автоматизацией браузера. Он предустановлен вместе с OpenClaw на каждом сервере ClawNode.',
        faq3Question:
            'Чем это отличается от других ИИ-инструментов или хостинговых платформ?',
        faq3Answer:
            'В отличие от хостинговых ИИ-инструментов, ClawNode предоставляет вам настоящий сервер с установленными OpenClaw и Hermes. Вы владеете инфраструктурой, контролируете всё и не ограничены общей платформой или моделью.',
    ...
    changelog: {
        ...
        description:
            'Отслеживайте обновления, новые функции и улучшения ClawNode.',
        subtitle: 'Все обновления, новые функции и улучшения ClawNode.',
        ...
        release15Feature1:
            'Упрощение и перенос управляемых функций в OpenClaw, больше никаких чата ClawNode, агентов, каналов, переменных и навыков',
        release15Feature2:
        ...
        release12Description:
            'Годовые подписки с 2 бесплатными месяцами, голосовой режим, переустановка экземпляра и начальный лендинг для ClawNode Go.',
        release12Feature1:
            'Лендинг для ClawNode Go, локальный хостинг с ClawNode',
        release12Feature2:
            'Поддержка годовых подписок с 2 бесплатными месяцами при годовой оплате',
        release12Feature3:
            'Голосовой режим для взаимодействия с агентами OpenClaw на ClawNode',
        release12Feature4:
        ...
        release1Description:
            'Первый официальный релиз ClawNode. Разверните OpenClaw на собственном VPS в один клик.',
        ...
        release2Description:
            'Новый способ быть в курсе всего, что касается ClawNode.',
        release2Feature1:
    ...
    clawDetail: {
        ...
        loadingTip3:
            'ClawNode — первый в мире проект, позволяющий хостить OpenClaw в один клик.',
        loadingTip4:
        ...
        loadingTip13:
            'ClawNode поддерживает серверы в нескольких регионах Европы и США.',
    ...
    privacy: {
        ...
        eligibilityText:
            'Наш Сервис доступен для всех. Ограничений по возрасту для использования ClawNode нет.',
    ...
    terms: {
        ...
        description:
            'Ознакомьтесь с условиями использования сервисов ClawNode.',
        lastUpdated: 'Последнее обновление: 14 марта 2026',
        acceptanceTitle: '1. Принятие условий',
        acceptanceText:
            'Получая доступ и используя ClawNode («Сервис»), вы принимаете и соглашаетесь соблюдать условия и положения данного соглашения. Если вы не согласны с этими условиями, пожалуйста, не используйте наш Сервис.',
        serviceTitle: '2. Описание Сервиса',
        serviceText:
            'ClawNode обеспечивает развёртывание OpenClaw и Hermes в один клик на выделенных серверах. Мы позволяем пользователям разворачивать, управлять и получать доступ к предварительно настроенным экземплярам OpenClaw и Hermes с полным root-доступом и выделенными ресурсами.',
        ...
        liabilityText:
            'В максимальной степени, допускаемой законом, ClawNode не несёт ответственности за любой косвенный, случайный, особый, последующий или штрафной ущерб, а также за потерю прибыли или доходов, понесённых прямо или косвенно.',
    ...
    hermesBanner: {
        title: 'Hermes Agent',
        message:
            'Агенты Hermes теперь поддерживаются для развёртывания на ClawNode.'
    },
    compare: {
        title: 'Сравнение',
        description:
            'Посмотрите, как ClawNode сравнивается с другими платформами хостинга OpenClaw.',
        badge: 'Сравнение',
        feature: 'Платформа',
    ...
    affiliateProgram: {
        ...
        description:
            'Узнайте, как работает партнёрская программа ClawNode, сколько вы можете заработать и правила участия.',
        lastUpdated: 'Последнее обновление: 1 апреля 2026 г.',
        overviewTitle: '1. Обзор',
        overviewText:
            'Партнёрская программа ClawNode позволяет вам зарабатывать вознаграждения, приглашая новых пользователей в ClawNode. Когда кто-то совершает покупку после посещения ClawNode по вашей реферальной ссылке, вы получаете комиссию с его платежей. Программа бесплатна и доступна всем зарегистрированным пользователям ClawNode.',
        howItWorksTitle: '2. Как это работает',
        howItWorksText: 'Начать работу с партнёрской программой просто:',
        howItWorksStep1:
            'Зарегистрируйте аккаунт ClawNode. Уникальный реферальный код генерируется для вас автоматически.',
        howItWorksStep2:
            'Поделитесь своей реферальной ссылкой с друзьями, коллегами или вашей аудиторией. Ваша ссылка имеет формат: clawnode.cloud?ref=YOUR_CODE.',
        howItWorksStep3:
            'Когда кто-то совершает покупку после посещения ClawNode по вашей ссылке, это регистрируется как ваш реферал.',
        howItWorksStep4:
        ...
        earningsCommission:
            'Вы получаете комиссию 15% с каждой соответствующей покупки, совершённой вашими приглашёнными пользователями. Комиссии распространяются на планы ClawNode Cloud и ClawNode Go.',
        earningsMonthly:
        ...
        rulesNoMisrepresentation:
            'Вы не можете искажать информацию о ClawNode, его услугах или партнёрской программе каким-либо образом.',
        rulesNoIncentivized:
        ...
        terminationText:
            'Любое нарушение этих правил приведёт к немедленной потере всех ожидающих и заработанных вознаграждений. ClawNode оставляет за собой право приостановить или навсегда заблокировать ваш аккаунт в партнёрской программе. В серьёзных случаях ваш аккаунт ClawNode также может быть закрыт. Все решения относительно нарушений являются окончательными.',
        ...
        marketingSocial:
            'Делитесь ссылкой в социальных сетях, таких как X, LinkedIn, Reddit и Facebook. Напишите о своём опыте с ClawNode и включите реферальную ссылку.',
        marketingBlog:
            'Пишите статьи в блоге, руководства или обзоры о ClawNode. Естественно включайте реферальную ссылку в контент.',
        marketingVideo:
            'Создавайте видеоконтент на YouTube или TikTok, демонстрируя, как вы используете ClawNode для развёртывания и управления ИИ-агентами.',
        marketingCommunity:
            'Участвуйте в сообществах разработчиков, форумах и серверах Discord. Когда кто-то спрашивает об облачном хостинге или развёртывании ИИ-агентов, рекомендуйте ClawNode со своей ссылкой.',
        marketingNewsletter:
            'Если вы ведёте рассылку или список электронной почты, упомяните ClawNode в соответствующем выпуске с вашей реферальной ссылкой.',
        marketingComparison:
            'Пишите честные сравнительные статьи или руководства, которые подчёркивают, чем ClawNode отличается от других платформ.',
        changesToProgramTitle: '10. Изменения в программе',
        changesToProgramText:
            'ClawNode оставляет за собой право изменять, приостанавливать или прекращать партнёрскую программу в любое время без предварительного уведомления. Это включает изменения комиссионных ставок, окон рефералов, порогов выплат и правил программы. Продолжение участия после изменений означает принятие обновлённых условий.',
