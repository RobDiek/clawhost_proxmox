const en = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Download this agent and all its data as a .zip file.',
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'Enable preview to embed your agent directly in the dashboard.',
        ...
        volumesEmptyDescription: 'This instance has no persistent storage volumes.',
        volumesReadOnly: 'Storage can only be added during instance creation. To add storage, deploy a new instance with the desired volume size, or contact the',
        ...
        metricsErrorDescription: 'Could not connect to the server to retrieve metrics. Please check that the instance is running.',
