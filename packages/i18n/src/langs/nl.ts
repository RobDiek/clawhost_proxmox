...
const nl: Translations = {
    ...
    api: {
        ...
        providerNotAllowed:
            'Deze provider is niet beschikbaar wanneer Hetzner actief is!',
        invalidPlan: 'Ongeldig plan geselecteerd!',
    ...
    createClaw: {
        ...
        providerUnavailable: 'Deze provider is momenteel niet beschikbaar.',
        providerDisabledHetznerRecommended: 'Niet beschikbaar',
        providerAtCapacity:
            'Door hoge vraag zijn servers van deze provider tijdelijk niet beschikbaar. We werken actief aan een oplossing.',
    ...
    changelog: {
        ...
        release13Date: '19 maart 2026',
        release13Title: 'Nieuwe talen & ClawHost Go Beta',
        release13Description:
            '10 nieuwe talen en ClawHost Go bèta voor lokale OpenClaw-deployment met één klik op macOS en Windows.',
        release13Feature1:
        ...
        release11Dropped1: 'Functieverzoeken verwijderd voor vereenvoudiging',
        ...
        release1Feature3:
            '18 Hetzner-serverplannen met dedicated vCPU, RAM en opslagopties',
        release1Feature4:
            '6 Hetzner-serverlocaties in de VS, Europa en Azi\u00eb',
    ...
    privacy: {
        ...
        serverInfoConfig:
            'Serverconfiguratie en -status (gehost op Hetzner Cloud)',
    ...
    terms: {
        ...
        changesToTermsTitle: '10. Wijzigingen in de voorwaarden',
        changesToTermsText:
        ...
        contactTitle: '11. Contactinformatie',
        contactText:
    ...
    announcement: {
        ...
        message:
            'Door hoge vraag zijn {{providers}}-deployments tijdelijk niet beschikbaar. Bestaande claws draaien normaal.'
    },
    productHunt: {
        liveOn: 'Live op',
