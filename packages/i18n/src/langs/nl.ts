...
const nl: Translations = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Download deze agent en al zijn gegevens als .zip-bestand.',
    ...
    clawDetail: {
        ...
        previewNotEnabled: 'Voorbeeld is niet ingeschakeld voor deze instantie.',
        previewNotEnabledDescription: 'Schakel voorbeeld in om uw agent direct in het dashboard in te sluiten.',
        ...
        volumesEmptyDescription: 'Deze instantie heeft geen persistente opslagvolumes.',
        volumesReadOnly: 'Opslag kan alleen worden toegevoegd tijdens het aanmaken van een instantie. Om opslag toe te voegen, deployt u een nieuwe instantie met de gewenste volumegrootte, of neem contact op met het',
        ...
        metricsErrorDescription: 'Kan geen verbinding maken met de server om statistieken op te halen. Controleer of de instantie actief is.',
