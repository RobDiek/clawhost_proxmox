...
const nl: Translations = {
    ...
    api: {
        ...
        clawEmojiUpdated: 'Agent-emoji bijgewerkt.',
    ...
    clawDetail: {
        ...
        securitySSHKeyHint: 'Wordt gebruikt bij het opnieuw installeren van de instantie.',
        ...
        settingsOptions: 'Opties',
        settingsDetails: 'Details',
        settingsDangerZone: 'Gevarenzone',
        settingsDangerZoneDescription: 'Verwijder deze instantie en al zijn gegevens permanent.',
