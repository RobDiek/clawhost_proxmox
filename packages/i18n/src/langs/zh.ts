...
const zh: Translations = {
    ...
    createClaw: {
        ...
        providerUnavailable: '此提供商目前不可用。',
        providerDisabledHetznerRecommended: '不可用',
        providerAtCapacity:
            '由于需求量大，此提供商的服务器暂时售罄。我们正在积极解决此问题。',
    ...
    changelog: {
        ...
        release13Date: '2026年3月19日',
        release13Title: '新语言与 ClawHost Go 测试版',
        release13Description:
            '新增10种语言，ClawHost Go 测试版支持在 macOS 和 Windows 上一键本地部署 OpenClaw。',
        release13Feature1:
    ...
    playground: {
        ...
        chatReadOnlyGoReply:
            '这是预览！获取 ClawHost Go 并在本地运行 OpenClaw——您的机器、您的数据，无需云端。',
