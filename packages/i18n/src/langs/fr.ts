...
const fr: Translations = {
    ...
    api: {
        ...
        clawDeletionAlreadyPassed: 'La date de suppression est déjà passée !',
        clawLimitReached:
            'Vous avez atteint la limite de {{max}} claws. Veuillez contacter le support pour augmenter cette limite !',
        sshKeyLimitReached:
            'Vous avez atteint la limite de {{max}} clés SSH. Veuillez contacter le support pour augmenter cette limite !',
        ...
        failedToGetMetrics: 'Échec de la récupération des métriques du serveur !',
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Télécharger cet agent et toutes ses données sous forme de fichier .zip.',
        exportStarted:
    ...
    changelog: {
        ...
        upcomingReleaseFeature13:
            'Version bêta de ClawHost Go pour macOS et Windows, déployez OpenClaw localement en un clic',
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: "Activez l'aperçu pour intégrer votre agent directement dans le tableau de bord.",
        ...
        volumesEmptyDescription: 'Cette instance n\'a pas de volumes de stockage persistants.',
        volumesReadOnly: 'Le stockage ne peut être ajouté que lors de la création de l\'instance. Pour ajouter du stockage, déployez une nouvelle instance avec la taille de volume souhaitée, ou contactez l\'',
        ...
        metricsErrorDescription: 'Impossible de se connecter au serveur pour récupérer les métriques. Veuillez vérifier que l\'instance est en cours d\'exécution.',
        metricsAutoRefresh: 'Actualisation automatique toutes les {{seconds}} secondes',
        tabBilling: 'Billing',
