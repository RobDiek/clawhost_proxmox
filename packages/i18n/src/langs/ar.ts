...
const ar: Translations = {
    ...
    emails: {
        ...
        changelogSubject: 'الجديد في ClawHost',
        changelogPreview: 'اطلع على آخر تحديثات ClawHost: {{title}}',
        ...
        features: {
            ...
            agentChat: {
                ...
                description:
                    'تحدث مع وكلاء الذكاء الاصطناعي مباشرة من لوحة تحكم ClawHost. أرسل رسائل وأرفق صوراً واعرض سجل المحادثات — كل ذلك في مكان واحد.',
                cta: 'ابدأ المحادثة'
            },
            voiceMode: {
    ...
    createClaw: {
        ...
        providerUnavailable: 'هذا المزود غير متاح حالياً.',
        providerDisabledHetznerRecommended: 'غير متاح',
        providerAtCapacity:
            'بسبب الطلب المرتفع، نفدت الخوادم مؤقتاً من هذا المزود. نعمل بنشاط على حل هذه المشكلة.',
    ...
    changelog: {
        ...
        release13Date: '19 مارس 2026',
        release13Title: 'لغات جديدة و ClawHost Go بيتا',
        release13Description:
            '10 لغات جديدة وإصدار ClawHost Go التجريبي لنشر OpenClaw محلياً بنقرة واحدة على macOS وWindows.',
        release13Feature1:
        ...
        release11Dropped1: 'إزالة طلبات الميزات للتبسيط',
