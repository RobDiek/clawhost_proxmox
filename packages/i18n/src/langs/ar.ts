...
const ar: Translations = {
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'فعّل المعاينة لعرض وكيلك مباشرة في لوحة التحكم.',
        ...
        volumesReadOnly: 'لا يمكن إضافة التخزين إلا أثناء إنشاء النسخة. لإضافة تخزين، انشر نسخة جديدة بحجم وحدة التخزين المطلوب، أو تواصل مع',
        ...
        metricsErrorDescription: 'تعذر الاتصال بالخادم لاسترداد المقاييس. يرجى التحقق من أن المثيل قيد التشغيل.',
