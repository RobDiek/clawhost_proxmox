...
const hi: Translations = {
    ...
    emails: {
        ...
        changelogSubject: 'ClawHost में नया क्या है',
        changelogPreview: 'ClawHost के नवीनतम अपडेट देखें: {{title}}',
        changelogHeading: 'नया क्या है',
        changelogButton: 'परिवर्तन लॉग देखें',
        changelogVisitButton: 'ClawHost पर जाएँ',
        changelogFooter:
    ...
    createClaw: {
        ...
        providerUnavailable: 'यह प्रदाता वर्तमान में अनुपलब्ध है.',
        providerDisabledHetznerRecommended: 'अनुपलब्ध',
        providerAtCapacity:
            'उच्च मांग के कारण, इस प्रदाता के सर्वर अस्थायी रूप से समाप्त हो गए हैं. हम इसे हल करने के लिए सक्रिय रूप से काम कर रहे हैं.',
    ...
    changelog: {
        ...
        release13Date: '19 मार्च 2026',
        release13Title: 'नई भाषाएँ और ClawHost Go बीटा',
        release13Description:
            '10 नई भाषाएँ और macOS तथा Windows पर एक क्लिक में OpenClaw डिप्लॉय करने के लिए ClawHost Go बीटा।',
        release13Feature1:
