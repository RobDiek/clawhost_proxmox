...
const hi: Translations = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'इस एजेंट और इसके सभी डेटा को .zip फ़ाइल के रूप में डाउनलोड करें।',
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'अपने एजेंट को सीधे डैशबोर्ड में एम्बेड करने के लिए पूर्वावलोकन सक्षम करें।',
        ...
        volumesEmptyDescription: 'इस इंस्टेंस में कोई स्थायी स्टोरेज वॉल्यूम नहीं है।',
        volumesReadOnly: 'स्टोरेज केवल इंस्टेंस निर्माण के दौरान जोड़ा जा सकता है। स्टोरेज जोड़ने के लिए, वांछित वॉल्यूम आकार के साथ एक नई इंस्टेंस तैनात करें, या संपर्क करें',
        ...
        metricsErrorDescription: 'मेट्रिक्स प्राप्त करने के लिए सर्वर से कनेक्ट नहीं हो सका। कृपया जांचें कि इंस्टेंस चल रहा है।',
