...
const hi: Translations = {
    ...
    go: {
        ...
        features: 'विशेषताएँ',
        whyClawNodeGo: 'ऑल-इन-वन विशेषताएँ',
        featuresDescription:
        ...
        faqDescription:
            'ClawNode Go के बारे में वह सब कुछ जो आपको जानना चाहिए.',
        faq1Question: 'ClawNode Go क्या है?',
        faq1Answer:
            'ClawNode Go एक हल्का डेस्कटॉप एप्लिकेशन है जो आपको अपनी मशीन पर स्थानीय रूप से OpenClaw चलाने देता है. कोई क्लाउड सर्वर नहीं चाहिए — इंस्टॉल करें, लॉन्च करें और सेकंडों में OpenClaw का उपयोग शुरू करें.',
        faq2Question: 'Go, ClawNode Cloud से कैसे अलग है?',
        faq2Answer:
            'ClawNode Cloud, OpenClaw को 24/7 अपटाइम और वैश्विक पहुँच के साथ समर्पित रिमोट सर्वर पर डिप्लॉय करता है. ClawNode Go सब कुछ आपके डिवाइस पर स्थानीय रूप से चलाता है — गोपनीयता, ऑफ़लाइन उपयोग और सरल सेटअप के लिए बढ़िया.',
        faq3Question: 'क्या मुझे इंटरनेट कनेक्शन चाहिए?',
        faq3Answer:
            'ClawNode Go स्थानीय उपयोग के लिए ऑफ़लाइन काम करता है. इंटरनेट कनेक्शन केवल प्रारंभिक सेटअप, अपडेट और बाहरी API कॉल वाली सुविधाओं के लिए आवश्यक है.',
        faq4Question: 'क्या लाइसेंस एक बार का भुगतान है?',
        faq4Answer:
            'हाँ. आप एक बार भुगतान करते हैं और सभी भविष्य के अपडेट सहित ClawNode Go तक आजीवन पहुँच प्राप्त करते हैं. कोई सब्सक्रिप्शन नहीं, कोई आवर्ती शुल्क नहीं.',
        faq5Question: 'कौन से ऑपरेटिंग सिस्टम समर्थित हैं?',
        faq5Answer:
            'ClawNode Go, Windows और macOS को सपोर्ट करता है. दोनों प्लेटफ़ॉर्म पर समान सुविधाएँ मिलती हैं और एक साथ अपडेट आते हैं.',
        faq6Question: 'क्या मैं बाद में Go से Cloud पर स्विच कर सकता हूँ?',
        faq6Answer:
            'बिल्कुल. आप Go से अपना OpenClaw कॉन्फ़िगरेशन निर्यात कर सकते हैं और इसे कभी भी ClawNode Cloud पर डिप्लॉय कर सकते हैं. दोनों प्लेटफ़ॉर्म पूरी तरह संगत हैं.',
        statsPrice: '${{price}}',
        statsLifetime: 'आजीवन',
        statsOneTime: 'एक बार',
        statsPayment: 'भुगतान',
        ...
        deviceNotSupported: 'आपका डिवाइस अभी ClawNode Go द्वारा समर्थित नहीं है।',
    ...
    footer: {
        ...
        productDescription:
            'एक क्लिक में क्लाउड या स्थानीय रूप से OpenClaw और Hermes एजेंट डिप्लॉय करें — ClawNode के साथ अपने AI एजेंट तेज़ी से बनाएँ, कनेक्ट करें और स्केल करें.',
        ariaGithub: 'GitHub',
        ariaX: 'X',
    ...
    emails: {
        otpSubject: 'आपका ClawNode साइन-इन कोड',
        otpPreview: 'आपका ClawNode साइन-इन कोड: {{code}}',
        otpHeading: 'आपका साइन-इन कोड है:',
        otpExpiry:
            'कोड 10 मिनट में समाप्त हो जाएगा. यदि यह आप नहीं थे, तो इस ईमेल को अनदेखा करें.',
        featureFooter:
            'आपको यह इसलिए प्राप्त हो रहा है क्योंकि आपके पास एक ClawNode खाता है.',
        features: {
            terminal: {
                ...
                description:
                    'हमारे बिल्ट-इन टर्मिनल से अपने सर्वर को सीधे ब्राउज़र से एक्सेस करें. कोई SSH क्लाइंट नहीं चाहिए — बस ClawNode खोलें और कमांड टाइप करना शुरू करें.',
                cta: 'टर्मिनल खोलें'
            },
            logs: {
                ...
                description:
                    'ClawNode डैशबोर्ड से रीयल टाइम में अपने सर्वर लॉग मॉनिटर करें. ब्राउज़र छोड़े बिना समस्याओं का निदान करें, डिप्लॉयमेंट ट्रैक करें और अपने एप्लिकेशन डीबग करें.',
                cta: 'लॉग देखें'
            },
            fileExplorer: {
                subject:
                ...
                description:
                    'ClawNode डैशबोर्ड से सीधे अपने सर्वर पर फ़ाइलें ब्राउज़ करें, पढ़ें और संपादित करें. सिंटैक्स हाइलाइटिंग, खोज और तुरंत सहेजना — कोई SSH नहीं चाहिए.',
            ...
            sshKeys: {
                subject:
                    'क्या आप जानते हैं? ClawNode से SSH कुंजियाँ प्रबंधित करें',
                preview: 'डैशबोर्ड में SSH कुंजी जोड़ी बनाएँ और प्रबंधित करें',
                tag: 'SSH कीज़',
                heading: 'SSH कुंजियाँ, सरलीकृत',
                description:
                    'SSH कुंजी जोड़ी बनाएँ, सार्वजनिक कुंजियाँ कॉपी करें और निजी कुंजियाँ डाउनलोड करें — सब कुछ ClawNode डैशबोर्ड से. सुरक्षित पहुँच के लिए क्लॉज़ को कुंजियाँ असाइन करें.',
            ...
            multiLanguage: {
                subject: 'क्या आप जानते हैं? ClawNode आपकी भाषा बोलता है',
                preview: 'ClawNode को 14 भाषाओं में उपयोग करें',
                tag: 'मल्टी-लैंग्वेज',
                heading: 'आपकी भाषा में ClawNode',
                description:
                    'पूरे ClawNode डैशबोर्ड को 14 भाषाओं में से किसी में भी बदलें. बटनों से लेकर त्रुटि संदेशों तक — सब कुछ पूरी तरह अनुवादित.',
                cta: 'भाषा बदलें'
            },
            subdomain: {
            ...
            darkMode: {
                subject: 'क्या आप जानते हैं? ClawNode में डार्क मोड है',
                preview: 'लाइट और डार्क थीम के बीच स्विच करें',
                tag: 'डार्क मोड',
                heading: 'आँखों पर आसान',
                description:
                    'ClawNode डैशबोर्ड में लाइट और डार्क थीम के बीच टॉगल करें. आपकी पसंद सहेजी जाती है और हर बार स्वचालित रूप से लागू होती है.',
    ...
    auth: {
        signIn: 'प्रमाणीकरण',
        signInDescription:
            'अपने OpenClaw इंस्टेंस प्रबंधित करने के लिए अपने ClawNode खाते में साइन इन करें.',
    ...
    account: {
        title: 'खाता',
        description:
            'अपने ClawNode खाते की सेटिंग्स और प्रोफ़ाइल जानकारी प्रबंधित करें.',
    ...
    license: {
        ...
        gateDescription:
            'स्थानीय रूप से OpenClaw इंस्टेंस डिप्लॉय और प्रबंधित करने के लिए आपको ClawNode Go लाइसेंस की आवश्यकता है.'
    },
    network: {
    ...
    dashboard: {
        ...
        dnsSetupBanner:
            'subdomain.clawnode के माध्यम से अपने क्लॉज़ तक पहुँचने के लिए स्थानीय DNS सेट करें.',
    ...
    landing: {
        ...
        tutorialVideoThumbnail: 'ClawNode ट्यूटोरियल वीडियो थंबनेल',
        ...
        features: 'विशेषताएँ',
        whyClawNode: 'ऑल-इन-वन विशेषताएँ',
        featuresDescription:
            'हम क्यों आज़माने लायक हैं, विशेषताएँ झूठ नहीं बोलतीं.',
        zeroConfigDescription:
        ...
        faq1Question: 'ClawNode क्या है?',
        faq1Answer:
            'ClawNode एक प्लेटफ़ॉर्म है जो OpenClaw और Hermes को सभी के लिए सुलभ बनाने के लिए बनाया गया है. यह गैर-तकनीकी उपयोगकर्ताओं और डेवलपर्स दोनों को बुनियादी ढांचे का प्रबंधन किए बिना उन्हें चलाने देता है. हम सर्वर, अपटाइम, सुरक्षा और रखरखाव संभालते हैं — आप बस अपने एजेंट का उपयोग करते हैं.',
        ...
        faqHermesAnswer:
            'Hermes एक स्वायत्त AI एजेंट है जिसमें वेब ब्राउज़िंग, कैलेंडर प्रबंधन, बहु-मॉडल तर्क और ब्राउज़र स्वचालन शामिल है. यह हर ClawNode सर्वर पर OpenClaw के साथ पहले से इंस्टॉल आता है.',
        faq3Question: 'यह अन्य AI टूल या होस्टेड प्लेटफ़ॉर्म से कैसे अलग है?',
        faq3Answer:
            'होस्टेड AI टूल के विपरीत, ClawNode आपको OpenClaw और Hermes स्थापित एक वास्तविक सर्वर देता है. आप बुनियादी ढांचे के मालिक हैं, सब कुछ नियंत्रित करते हैं, और साझा प्लेटफ़ॉर्म या मॉडल द्वारा सीमित नहीं हैं.',
    ...
    changelog: {
        title: 'परिवर्तन लॉग',
        description: 'ClawNode के अपडेट, नई सुविधाएँ और सुधारों को ट्रैक करें.',
        subtitle: 'ClawNode के सभी अपडेट, नई सुविधाएँ और सुधार.',
        ...
        release15Feature1:
            'सरलीकरण और प्रबंधित सुविधाओं को OpenClaw में माइग्रेट किया, अब कोई ClawNode चैट, एजेंट, चैनल, वेरिएबल और स्किल नहीं',
        release15Feature2:
        ...
        release12Description:
            '2 महीने मुफ़्त के साथ वार्षिक सब्सक्रिप्शन, वॉइस मोड, इंस्टेंस पुनः इंस्टॉल और ClawNode Go के लिए प्रारंभिक लैंडिंग पेज.',
        release12Feature1:
            'ClawNode Go के लिए लैंडिंग पेज, ClawNode के साथ स्थानीय होस्टिंग',
        release12Feature2:
            'वार्षिक सब्सक्रिप्शन समर्थन, वार्षिक सब्सक्राइब करने पर 2 महीने मुफ़्त',
        release12Feature3:
            'ClawNode पर होस्ट किए गए OpenClaw एजेंट के साथ बातचीत करने के लिए वॉइस मोड',
        release12Feature4:
        ...
        release1Description:
            'ClawNode की पहली आधिकारिक रिलीज़. एक क्लिक में अपने VPS पर OpenClaw डिप्लॉय करें.',
        ...
        release2Description: 'ClawNode के बारे में अपडेट रहने का एक नया तरीका.',
        release2Feature1:
    ...
    clawDetail: {
        ...
        loadingTip3:
            'ClawNode एक-क्लिक OpenClaw होस्टिंग की अनुमति देने वाला पहला प्रोजेक्ट है.',
        loadingTip4:
        ...
        loadingTip13:
            'ClawNode यूरोप और अमेरिका में कई क्षेत्रों में सर्वर का समर्थन करता है.',
    ...
    privacy: {
        ...
        eligibilityText:
            'हमारी सेवा किसी के लिए भी उपलब्ध है. ClawNode का उपयोग करने के लिए कोई आयु प्रतिबंध नहीं है.',
    ...
    terms: {
        ...
        description:
            'ClawNode सेवाओं का उपयोग करने के लिए नियम और शर्तें पढ़ें.',
        lastUpdated: 'अंतिम अपडेट: 14 मार्च 2026',
        acceptanceTitle: '1. शर्तों की स्वीकृति',
        acceptanceText:
            'ClawNode ("सेवा") तक पहुँचकर और इसका उपयोग करके, आप इस समझौते की शर्तों और प्रावधानों से बाध्य होने को स्वीकार और सहमत होते हैं. यदि आप इन शर्तों से सहमत नहीं हैं, तो कृपया हमारी सेवा का उपयोग न करें.',
        serviceTitle: '2. सेवा का विवरण',
        serviceText:
            'ClawNode डेडिकेटेड सर्वरों पर OpenClaw और Hermes की एक-क्लिक डिप्लॉयमेंट प्रदान करता है. हम उपयोगकर्ताओं को पूर्ण रूट एक्सेस और डेडिकेटेड संसाधनों के साथ पूर्व-कॉन्फ़िगर OpenClaw और Hermes इंस्टेंस को डिप्लॉय, प्रबंधित और एक्सेस करने में सक्षम बनाते हैं.',
        authTitle: '3. प्रमाणीकरण',
        authText:
            'ClawNode साइन-इन प्रबंधित करने के लिए Google Firebase Authentication का उपयोग करता है. आप ईमेल, Google या GitHub से प्रमाणित कर सकते हैं. इन विधियों का उपयोग करके, आप Google और GitHub की संबंधित शर्तों और गोपनीयता नीतियों से सहमत होते हैं. ये प्रदाता आपके ईमेल पते, नाम और डिवाइस डेटा जैसी बुनियादी जानकारी एकत्र कर सकते हैं.',
        ...
        liabilityText:
            'कानून द्वारा अनुमत अधिकतम सीमा तक, ClawNode किसी भी अप्रत्यक्ष, आकस्मिक, विशेष, परिणामी या दंडात्मक क्षति, या प्रत्यक्ष या अप्रत्यक्ष रूप से हुए लाभ या राजस्व के किसी भी नुकसान के लिए उत्तरदायी नहीं होगा.',
    ...
    hermesBanner: {
        title: 'Hermes Agent',
        message: 'Hermes एजेंट अब ClawNode पर डिप्लॉयमेंट के लिए समर्थित हैं।'
    },
    compare: {
        title: 'तुलना',
        description:
            'देखें कि ClawNode अन्य OpenClaw होस्टिंग प्लेटफ़ॉर्म की तुलना में कैसा है.',
        badge: 'तुलना',
        feature: 'प्लेटफ़ॉर्म',
    ...
    affiliateProgram: {
        ...
        description:
            'जानें कि ClawNode सहबद्ध कार्यक्रम कैसे काम करता है, आप कितना कमा सकते हैं और भाग लेने के नियम क्या हैं।',
        lastUpdated: 'अंतिम अपडेट: 1 अप्रैल 2026',
        overviewTitle: '1. अवलोकन',
        overviewText:
            'ClawNode सहबद्ध कार्यक्रम आपको नए उपयोगकर्ताओं को ClawNode पर रेफर करके पुरस्कार अर्जित करने देता है। जब कोई आपके रेफरल लिंक के माध्यम से ClawNode पर जाने के बाद खरीदारी करता है, तो आप उनके भुगतान पर कमीशन कमाते हैं। कार्यक्रम में शामिल होना मुफ्त है और सभी पंजीकृत ClawNode उपयोगकर्ताओं के लिए उपलब्ध है।',
        howItWorksTitle: '2. यह कैसे काम करता है',
        howItWorksText: 'सहबद्ध कार्यक्रम शुरू करना आसान है:',
        howItWorksStep1:
            'एक ClawNode खाता बनाएं। आपके लिए स्वचालित रूप से एक अद्वितीय रेफरल कोड तैयार किया जाता है।',
        howItWorksStep2:
            'अपना रेफरल लिंक दोस्तों, सहकर्मियों या अपने दर्शकों के साथ साझा करें। आपका लिंक इस प्रारूप का अनुसरण करता है: clawnode.cloud?ref=YOUR_CODE।',
        howItWorksStep3:
            'जब कोई आपके लिंक के माध्यम से ClawNode पर जाने के बाद खरीदारी करता है, तो इसे आपके रेफरल के रूप में ट्रैक किया जाता है।',
        howItWorksStep4:
        ...
        earningsCommission:
            'आप अपने रेफर किए गए उपयोगकर्ताओं द्वारा की गई हर योग्य खरीदारी पर 15% कमीशन कमाते हैं। कमीशन ClawNode Cloud और ClawNode Go दोनों योजनाओं पर लागू होते हैं।',
        earningsMonthly:
        ...
        rulesNoMisrepresentation:
            'आप किसी भी तरह से ClawNode, इसकी सेवाओं या सहबद्ध कार्यक्रम को गलत तरीके से प्रस्तुत नहीं कर सकते।',
        rulesNoIncentivized:
        ...
        terminationText:
            'इन नियमों के किसी भी उल्लंघन का परिणाम सभी लंबित और अर्जित पुरस्कारों की तत्काल जब्ती होगी। ClawNode सहबद्ध कार्यक्रम से आपके खाते को निलंबित या स्थायी रूप से प्रतिबंधित करने का अधिकार सुरक्षित रखता है। गंभीर मामलों में, आपका ClawNode खाता भी समाप्त किया जा सकता है। उल्लंघनों के संबंध में सभी निर्णय अंतिम हैं।',
        marketingTitle: '9. कैसे प्रचार करें',
        marketingText:
            'अपना रेफरल लिंक साझा करने और अपनी कमाई बढ़ाने के कई रचनात्मक और वैध तरीके हैं:',
        marketingSocial:
            'X, LinkedIn, Reddit और Facebook जैसे सोशल मीडिया प्लेटफॉर्म पर अपना लिंक साझा करें। ClawNode के साथ अपने अनुभव के बारे में लिखें और अपना रेफरल लिंक शामिल करें।',
        marketingBlog:
            'ClawNode के बारे में ब्लॉग पोस्ट, ट्यूटोरियल या समीक्षाएं लिखें। सामग्री में स्वाभाविक रूप से अपना रेफरल लिंक शामिल करें।',
        marketingVideo:
            'YouTube या TikTok पर वीडियो सामग्री बनाएं जो दिखाए कि आप AI एजेंटों को तैनात और प्रबंधित करने के लिए ClawNode का उपयोग कैसे करते हैं।',
        marketingCommunity:
            'डेवलपर समुदायों, फोरम और Discord सर्वर में भाग लें। जब कोई क्लाउड होस्टिंग या AI एजेंट तैनाती के बारे में पूछे, तो अपने लिंक के साथ ClawNode की सिफारिश करें।',
        marketingNewsletter:
            'यदि आप न्यूज़लेटर या ईमेल सूची चलाते हैं, तो किसी प्रासंगिक अंक में अपने रेफरल लिंक के साथ ClawNode का उल्लेख करें।',
        marketingComparison:
            'ईमानदार तुलना लेख या गाइड लिखें जो यह उजागर करें कि ClawNode को अन्य प्लेटफॉर्म से क्या अलग बनाता है।',
        changesToProgramTitle: '10. कार्यक्रम में परिवर्तन',
        changesToProgramText:
            'ClawNode बिना पूर्व सूचना के किसी भी समय सहबद्ध कार्यक्रम को संशोधित, निलंबित या बंद करने का अधिकार सुरक्षित रखता है। इसमें कमीशन दरों, रेफरल विंडो, भुगतान सीमा और कार्यक्रम नियमों में परिवर्तन शामिल हैं। परिवर्तनों के बाद निरंतर भागीदारी अद्यतन शर्तों की स्वीकृति मानी जाती है।',
