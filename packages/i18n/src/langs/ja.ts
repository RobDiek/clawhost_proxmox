...
const ja: Translations = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'このエージェントとすべてのデータを.zipファイルとしてダウンロードします。',
    ...
    clawDetail: {
        ...
        closeDetails: '閉じる',
        tabPreview: 'プレビュー',
        previewNotEnabled: 'このインスタンスではプレビューが有効になっていません。',
        previewNotEnabledDescription: 'プレビューを有効にして、エージェントをダッシュボードに直接埋め込みます。',
        ...
        volumesEmptyDescription: 'このインスタンスには永続ストレージボリュームがありません。',
        volumesReadOnly: 'ストレージはインスタンス作成時にのみ追加できます。ストレージを追加するには、希望のボリュームサイズで新しいインスタンスをデプロイするか、',
        ...
        metricsErrorDescription: 'メトリクスを取得するためにサーバーに接続できませんでした。インスタンスが実行中であることを確認してください。',
