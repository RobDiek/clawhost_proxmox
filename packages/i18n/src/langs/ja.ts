...
const ja: Translations = {
    ...
    createClaw: {
        ...
        providerUnavailable: 'このプロバイダーは現在利用できません。',
        providerDisabledHetznerRecommended: '利用不可',
        providerAtCapacity:
            '需要が高いため、このプロバイダーのサーバーが一時的に不足しています。解決に向けて積極的に取り組んでいます。',
    ...
    changelog: {
        ...
        release13Title: '新言語対応 & ClawHost Go ベータ版',
        release13Description:
            '10の新言語とClawHost Goベータ版でmacOSとWindowsにワンクリックでOpenClawをローカルデプロイ。',
        release13Feature1:
