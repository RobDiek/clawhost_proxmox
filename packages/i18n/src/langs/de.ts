...
const de: Translations = {
    ...
    api: {
        ...
        clawEmojiUpdated: 'Agent-Emoji aktualisiert.',
    ...
    clawDetail: {
        ...
        securitySSHKeyHint: 'Wird bei der Neuinstallation der Instanz verwendet.',
        ...
        settingsDangerZoneDescription: 'Diese Instanz und alle ihre Daten dauerhaft löschen.',
