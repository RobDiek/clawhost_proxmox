...
const de: Translations = {
    ...
    api: {
        ...
        clawDeletionAlreadyPassed: 'Löschdatum ist bereits vergangen!',
        clawLimitReached:
            'Du hast das Limit von {{max}} Claws erreicht. Bitte kontaktiere den Support, um dieses Limit zu erhöhen!',
        sshKeyLimitReached:
            'Du hast das Limit von {{max}} SSH-Schlüsseln erreicht. Bitte kontaktiere den Support, um dieses Limit zu erhöhen!',
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Diesen Agent und alle seine Daten als .zip-Datei herunterladen.',
        exportStarted:
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'Aktivieren Sie die Vorschau, um Ihren Agent direkt im Dashboard einzubetten.',
        ...
        volumesEmptyDescription: 'Diese Instanz hat keine persistenten Speicher-Volumes.',
        volumesReadOnly: 'Speicher kann nur während der Instanzerstellung hinzugefügt werden. Um Speicher hinzuzufügen, stellen Sie eine neue Instanz mit der gewünschten Volume-Größe bereit, oder kontaktieren Sie das',
        ...
        metricsErrorDescription: 'Verbindung zum Server konnte nicht hergestellt werden, um Metriken abzurufen. Bitte überprüfen Sie, ob die Instanz läuft.',
        metricsAutoRefresh: 'Automatische Aktualisierung alle {{seconds}} Sekunden',
        tabBilling: 'Billing',
