...
const it: Translations = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Scarica questo agente e tutti i suoi dati come file .zip.',
        exportStarted:
    ...
    clawDetail: {
        ...
        selectClaw: 'Seleziona un Claw',
        selectClawDescription:
            'Scegli un Claw dalla barra laterale per visualizzarne i dettagli.',
        closeDetails: 'Chiudi',
        tabPreview: 'Anteprima',
        previewNotEnabled: "L'anteprima non è abilitata per questa istanza.",
        previewNotEnabledDescription: "Abilita l'anteprima per incorporare il tuo agente direttamente nella dashboard.",
        ...
        volumesEmptyDescription: 'Questa istanza non ha volumi di archiviazione persistenti.',
        volumesReadOnly: 'Lo spazio di archiviazione può essere aggiunto solo durante la creazione dell\'istanza. Per aggiungere spazio di archiviazione, esegui il deployment di una nuova istanza con la dimensione del volume desiderata, o contatta il',
        ...
        metricsErrorDescription: 'Impossibile connettersi al server per recuperare le metriche. Verificare che l\'istanza sia in esecuzione.',
