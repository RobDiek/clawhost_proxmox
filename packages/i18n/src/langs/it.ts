...
const it: Translations = {
    ...
    api: {
        ...
        providerNotAllowed:
            'Questo provider non \u00e8 disponibile quando Hetzner \u00e8 attivo!',
        invalidPlan: 'Piano selezionato non valido!',
    ...
    changelog: {
        ...
        release13Date: '19 marzo 2026',
        release13Title: 'Nuove lingue e ClawHost Go Beta',
        release13Description:
            '10 nuove lingue e ClawHost Go beta per il deployment locale di OpenClaw con un clic su macOS e Windows.',
        release13Feature1:
        ...
        release1Feature1: 'Distribuzione OpenClaw con un clic su Hetzner Cloud',
        release1Feature2:
    ...
    privacy: {
        ...
        serverInfoConfig:
            'Configurazione e stato del server (ospitato su Hetzner Cloud)',
