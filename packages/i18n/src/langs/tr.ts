...
const tr: Translations = {
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Bu ajanı ve tüm verilerini .zip dosyası olarak indirin.',
    ...
    clawDetail: {
        ...
        previewNotEnabledDescription: 'Ajanınızı doğrudan panele gömmek için önizlemeyi etkinleştirin.',
        ...
        volumesEmptyDescription: 'Bu örneğin kalıcı depolama birimi bulunmuyor.',
        volumesReadOnly: 'Depolama yalnızca örnek oluşturma sırasında eklenebilir. Depolama eklemek için istenen birim boyutuyla yeni bir örnek dağıtın veya',
        ...
        metricsErrorDescription: 'Metrikleri almak için sunucuya bağlanılamadı. Lütfen örneğin çalışır durumda olduğunu kontrol edin.',
