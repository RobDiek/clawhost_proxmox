...
const tr: Translations = {
    ...
    createClaw: {
        ...
        providerUnavailable: 'Bu sağlayıcı şu anda kullanılamaz.',
        providerDisabledHetznerRecommended: 'Kullanılamaz',
        providerAtCapacity:
            'Yoğun talep nedeniyle bu sağlayıcıdan geçici olarak sunucu kalmadı. Sorunu çözmek için aktif olarak çalışıyoruz.',
    ...
    changelog: {
        ...
        release13Date: '19 Mart 2026',
        release13Title: 'Yeni Diller ve ClawHost Go Beta',
        release13Description:
            '10 yeni dil ve macOS ile Windows üzerinde tek tıkla yerel OpenClaw dağıtımı için ClawHost Go beta.',
        release13Feature1:
