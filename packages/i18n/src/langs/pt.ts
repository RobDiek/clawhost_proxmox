...
const pt: Translations = {
    ...
    api: {
        ...
        clawDeletionAlreadyPassed: 'A data de exclusão já passou!',
        clawLimitReached:
            'Você atingiu o limite de {{max}} claws. Entre em contato com o suporte para aumentar este limite!',
        sshKeyLimitReached:
            'Você atingiu o limite de {{max}} chaves SSH. Entre em contato com o suporte para aumentar este limite!',
    ...
    dashboard: {
        ...
        exportAgentTooltip: 'Baixar este agente e todos os seus dados como arquivo .zip.',
    ...
    clawDetail: {
        ...
        previewNotEnabled: 'A visualização não está habilitada para esta instância.',
        previewNotEnabledDescription: 'Habilite a visualização para incorporar seu agente diretamente no painel.',
        ...
        volumesEmptyDescription: 'Esta instância não possui volumes de armazenamento persistentes.',
        volumesReadOnly: 'O armazenamento só pode ser adicionado durante a criação da instância. Para adicionar armazenamento, implante uma nova instância com o tamanho de volume desejado, ou entre em contato com a',
        ...
        metricsErrorDescription: 'Não foi possível conectar ao servidor para obter as métricas. Verifique se a instância está em execução.',
        metricsAutoRefresh: 'Atualização automática a cada {{seconds}} segundos',
        tabBilling: 'Billing',
