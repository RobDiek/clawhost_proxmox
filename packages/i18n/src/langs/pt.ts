...
const pt: Translations = {
    ...
    api: {
        ...
        providerNotAllowed:
            'Este provedor não está disponível quando o Hetzner está ativo!',
        invalidPlan: 'Plano selecionado inválido!',
    ...
    emails: {
        ...
        changelogSubject: 'Novidades no ClawHost',
        changelogPreview:
            'Confira as últimas atualizações do ClawHost: {{title}}',
        changelogHeading: 'Novidades',
        ...
        features: {
            ...
            channels: {
                ...
                description:
                    'Conecte seus agentes de IA ao Discord, Slack, WhatsApp e mais. Configure canais e vincule-os a agentes — tudo pelo painel do ClawHost.',
    ...
    createClaw: {
        ...
        providerUnavailable: 'Este provedor está indisponível no momento.',
        providerDisabledHetznerRecommended: 'Indisponível',
        providerAtCapacity:
            'Devido à alta demanda, ficamos temporariamente sem servidores deste provedor. Estamos trabalhando ativamente para resolver isso.',
    ...
    landing: {
        ...
        globalLocationsDescription:
            'Implante o OpenClaw em várias regiões globais no Hetzner Cloud e escolha a localização mais próxima de você.',
        ...
        pricingDescription:
            'Escolha entre nossos servidores Hetzner Cloud com base nas suas necessidades.',
        planColumn: 'Servidor',
        vCpuColumn: 'vCPU',
        ramColumn: 'RAM',
        ...
        faq1Answer:
            'ClawHost é uma plataforma construída para tornar o OpenClaw acessível a todos. Permite que tanto usuários não técnicos quanto desenvolvedores executem o OpenClaw sem gerenciar infraestrutura. Nós cuidamos dos servidores, disponibilidade, segurança e manutenção — você apenas usa o OpenClaw.',
        ...
        faq3Answer:
            'Diferente de ferramentas de IA hospedadas, o ClawHost oferece um servidor real com OpenClaw instalado. Você é dono da infraestrutura, controla tudo e não está limitado por uma plataforma ou modelo compartilhado.',
        ...
        faq5Answer:
            'Oferecemos várias localizações de servidores em todo o mundo via Hetzner Cloud, incluindo Estados Unidos, Europa e mais. Você pode implantar o OpenClaw em vários servidores em diferentes regiões, se necessário.',
        ...
        faq8Question: 'Onde os servidores são hospedados?',
        faq8Answer:
            'Todos os servidores são hospedados no Hetzner Cloud, um provedor de nuvem confiável reconhecido por seu hardware de alto desempenho e excelente disponibilidade, usado por infraestruturas em grande escala.',
        comparison: 'Comparação',
    ...
    changelog: {
        ...
        upcomingReleaseFeature9:
            'Modo de Voz para interagir com os agentes OpenClaw hospedados no ClawHost (Beta)',
        ...
        release13Date: '19 de março de 2026',
        release13Title: 'Novos idiomas e ClawHost Go Beta',
        release13Description:
            '10 novos idiomas e ClawHost Go beta para implantação local do OpenClaw com um clique no macOS e Windows.',
        release13Feature1:
        ...
        release11Dropped1:
            'Removidas solicitações de recursos para simplificação',
        ...
        release1Feature1:
            'Implantação do OpenClaw com um clique no Hetzner Cloud',
        release1Feature2:
            'Painel para gerenciar claws, iniciar, parar, reiniciar e excluir instâncias',
        release1Feature3:
            '18 planos de servidor Hetzner com vCPU dedicada, RAM e opções de armazenamento',
        release1Feature4:
            '6 localizações de servidor Hetzner nos EUA, Europa e Ásia',
        release1Feature5:
    ...
    privacy: {
        ...
        serverInfoConfig:
            'Configuração e status do servidor (hospedado na Hetzner Cloud)',
    ...
    terms: {
        ...
        serviceText:
            'ClawHost fornece implantação do OpenClaw com um clique em servidores dedicados. Permitimos que os usuários implantem, gerenciem e acessem instâncias OpenClaw pré-configuradas com acesso root completo e recursos dedicados.',
        ...
        changesToTermsTitle: '10. Alterações nos Termos',
        changesToTermsText:
        ...
        contactTitle: '11. Informações de Contato',
        contactText:
    ...
    announcement: {
        ...
        message:
            'Devido à alta demanda, implantações {{providers}} estão temporariamente indisponíveis. Claws existentes estão funcionando normalmente.'
    },
    productHunt: {
        liveOn: 'Ao vivo no',
